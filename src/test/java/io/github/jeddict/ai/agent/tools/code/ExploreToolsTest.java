...
public class ExploreToolsTest extends BaseTest {
    ...
    throws Exception {
        ...
        final ListClassesInFileTool tool = new ListClassesInFileTool(projectDir);

        then(tool.listClassesInFile(path)).isEqualTo("File not found: " + path);
    }
    ...
    throws Exception {
        ...
        // to throw exceptions
        //
        then(tool.listClassesInFile(path)).isEqualTo("Not a Java source file: " + path);
    }
    ...
    throws Exception {
        ...
        final ListClassesInFileTool tool = new ListClassesInFileTool(projectDir);
        then(tool.listClassesInFile(path)).contains("Class: HelloWorld");
    }
    ...
    throws Exception {
        final String path = "non/existing/File.java";
        final ListMethodsInFileTool tool = new ListMethodsInFileTool(projectDir);

        then(tool.listMethodsInFile(path)).isEqualTo("File not found: " + path);
    }
    ...
    throws Exception {
        ...
        // to throw exceptions
        //
        then(tool.listMethodsInFile(path)).isEqualTo("Not a Java source file: " + path);
    }
    ...
    throws Exception {
        ...
        final ListMethodsInFileTool tool = new ListMethodsInFileTool(projectDir);
        then(tool.listMethodsInFile(path)).contains("Method: sayHello");
    }
    ...
    throws Exception {
        final String path = "non/existing/File.java";
        final FindUsagesTool tool = new FindUsagesTool(projectDir);

        then(tool.findUsages(path, "sayHello")).isEqualTo("File not found: " + path);
    }
    ...
    throws Exception {
        ...
        // to throw exceptions
        //
        then(tool.findUsages(path, "sayHello")).isEqualTo("Not a Java source file: " + path);
    }
    ...
    throws Exception {
        ...
        final FindUsagesTool tool = new FindUsagesTool(projectDir);
        then(tool.findUsages(path, "sayHello")).contains("Usage: sayHello"); // TO BE FIXED...
    }
}

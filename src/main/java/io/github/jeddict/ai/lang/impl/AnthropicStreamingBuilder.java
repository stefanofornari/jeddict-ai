 ...
 */
public class AnthropicStreamingBuilder implements ChatModelStreamingBuilder {

    private final AnthropicStreamingChatModel.AnthropicStreamingChatModelBuilder builder;

    public AnthropicStreamingBuilder() {
        builder = AnthropicStreamingChatModel.builder();
    }

 ...
 */
public class MistralBuilder implements ChatModelBuilder {

    private final MistralAiChatModel.MistralAiChatModelBuilder builder;

    public MistralBuilder() {
        builder = MistralAiChatModel.builder();
    }

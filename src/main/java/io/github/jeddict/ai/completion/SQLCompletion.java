...
public class SQLCompletion {
    ...
    private final SQLEditorSupport sQLEditorSupport;

    public SQLCompletion(SQLEditorSupport sQLEditorSupport) {
        this.sQLEditorSupport = sQLEditorSupport;
    }
    
    public String getMetaData() {
        DatabaseConnection dbConnection = sQLEditorSupport.getDatabaseConnection();

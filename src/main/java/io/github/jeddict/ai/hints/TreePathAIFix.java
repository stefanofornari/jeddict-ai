 ...
 *
 */
public abstract class TreePathAIFix extends BaseAIFix {

    protected final PreferencesManager pm = PreferencesManager.getInstance();

    protected final TreePath treePath;

    public TreePathAIFix(final TreePathHandle treePathHandle, final Action action, final TreePath treePath) {
